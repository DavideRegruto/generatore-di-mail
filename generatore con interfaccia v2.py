...
class EmailGeneratorApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Outlook Training Generator v9.1 (With Labels)")
        self.geometry("900x850") # Aumentato leggermente altezza
        ...
        ### MODIFICA: Etichetta dinamica per il valore
        self.lbl_val_emails = ctk.CTkLabel(self.frame_params, text="50", font=("Arial", 12, "bold"), text_color="#2CC985")
        self.lbl_val_emails.grid(row=0, column=2, padx=10, pady=(10,0), sticky="e")

        ### MODIFICA: Aggiunto command=self.update_email_label
        ...
        ### MODIFICA: Etichetta dinamica per il valore
        self.lbl_val_colleghi = ctk.CTkLabel(self.frame_params, text="8", font=("Arial", 12, "bold"), text_color="#2CC985")
        self.lbl_val_colleghi.grid(row=2, column=2, padx=10, pady=(10,0), sticky="e")

        ### MODIFICA: Aggiunto command=self.update_colleghi_label
        ...
        ### MODIFICA: Etichetta dinamica per il valore
        self.lbl_val_attach = ctk.CTkLabel(self.frame_params, text="30%", font=("Arial", 12, "bold"), text_color="#2CC985")
        self.lbl_val_attach.grid(row=4, column=2, padx=10, pady=(10,0), sticky="e")

        ### MODIFICA: Aggiunto command=self.update_attach_label
    ...
    ### MODIFICA: Nuovi metodi per aggiornare le etichette ###
    def update_email_label(self, value):
        self.lbl_val_emails.configure(text=str(int(value)))

    def update_colleghi_label(self, value):
        self.lbl_val_colleghi.configure(text=str(int(value)))

    def update_attach_label(self, value):
        self.lbl_val_attach.configure(text=f"{int(value)}%")
    #########################################################
